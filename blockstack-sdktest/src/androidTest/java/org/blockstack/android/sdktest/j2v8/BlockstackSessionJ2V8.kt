...
class BlockstackSessionJ2V8(context: Context? = null, private val config: BlockstackConfig,
    ...
    fun handlePendingSignIn(authResponse: String, signInCallback: (Result<UserData>) -> Unit) {
        ...
        if (BuildConfig.DEBUG) {
            val error = Blockstack.verifyAuthResponse(authResponse)
            if (error != null) {
    ...
    @Suppress("unused")
    private class JSAndroidBridge(private val blockstackSession: BlockstackSessionJ2V8, private val v8: V8, private val v8blockstackAndroid: V8Object, private val v8userSessionAndroid: V8Object, private val httpClient: Call.Factory) {
    ...
    companion object {
        ...
        const val TAG = "BlockstackSessionJ2V8"
    }
}
